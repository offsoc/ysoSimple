package cn.butler.jdbcattack.config;
...
public class JdbcAttackConfig extends Config {
    @Override
    public void parse(CommandLine cmdLine) {
        ...
        final Class<? extends ObjectPayload> payloadClass = ObjectPayload.Utils.getPayloadClass("JdbcAttack",payloadType);
